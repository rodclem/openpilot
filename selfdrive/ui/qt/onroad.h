...
private:
  ...
  std::map<AudibleAlert, std::pair<QString, bool>> sound_map {
    // AudibleAlert, (file path, inf loop)
      {AudibleAlert::CHIME_DISENGAGE, {"../assets/sounds/chime_minus_15db.wav", false}},
      {AudibleAlert::CHIME_ENGAGE, {"../assets/sounds/chime_minus_15db.wav", false}},
      {AudibleAlert::CHIME_WARNING1, {"../assets/sounds/warning_1_minus_10db.wav", false}},
      ...
      {AudibleAlert::CHIME_WARNING_REPEAT, {"../assets/sounds/warning_repeat_minus_10db.wav", true}},
      {AudibleAlert::CHIME_ERROR, {"../assets/sounds/error_minus_10db.wav", false}},
      {AudibleAlert::CHIME_PROMPT, {"../assets/sounds/chime_minus_15db.wav", false}}
  };
